...
interface IMyToken:
    def transfer(_amount:uint256, __to:Address): nonpayable
...
@external
def _init_(stakingToken:IMyToken ):
...
@internal
    ...
    assert _manager == self.manager, "You are not autorized to manage this contract"



@external
def setRwardPerBlock(_amount:uint256 ):
